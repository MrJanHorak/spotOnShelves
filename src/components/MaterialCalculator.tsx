          ...
          <div className='flex items-center justify-between'>
            <div>
              <div className='text-sm font-medium text-blue-700 mb-1'>
                Combined Maximum Safe Weight Capacity
              </div>
              <div className='text-3xl font-bold text-blue-900'>
                {estimate.maxWeightCapacity} lbs
              </div>
              <div className='text-xs text-blue-600 mt-1'>
                (combined total, assuming load is evenly distributed across all
                shelves, with{' '}
          ...
          onClick={async () => {
            ...
            try {
              ...
              if (!container) {
                setExportMessage({
                  type: 'error',
                  text: 'Schematic not found. Please refresh and try again.',
                });
                return;
              }
              ...
              setExportMessage({
                type: 'success',
                text: 'Complete plan PDF exported.',
              });
            } catch (err) {
              console.error(err);
              setExportMessage({
        ...
        <button
          ...
          onClick={async () => {
            ...
            try {
              ...
              setExportMessage({
                type: 'success',
                text: 'Drilling templates exported.',
              });
            } catch (err) {
              console.error(err);
              setExportMessage({
        ...
        <button
          ...
          onClick={async () => {
            ...
            try {
              ...
              setExportMessage({
                type: 'success',
                text: 'Panoramic templates exported.',
              });
            } catch (err) {
              console.error(err);
              setExportMessage({
                type: 'error',
                text: 'Panoramic template generation failed.',
              });
            } finally {
              setExporting(false);
            }
